        ...
        stage('Testing & Publish') {
            steps {
                ...
                sh '''#!/bin/bash
                    ...
                    invoke unit-test --env-keys \${COMMIT}
                    invoke regression-test --env-keys \${COMMIT}

                    invoke build-sub-packages --package-key \${COMMIT}
                    invoke publish-pypi
                    
                    invoke smoke-test --env-keys \${COMMIT}
                '''
                }
              }
            }
